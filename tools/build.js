// More info on Webpack's Node API here: //webpack.github.io/docs/node.js-api.html
...
webpack(webpackConfig).run((err, stats) => {
    ...
    console.log('Your app has been complied in production mode and written to /dist. It\'s ready');
